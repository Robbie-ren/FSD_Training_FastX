...
public class PassengerController {
    ...
    public Passenger editProfileV2(Principal principal, @RequestBody PassengerEditProfileDto dto){
        return passengerService.editProfile(principal.getName(), dto);

    }

    @GetMapping("/id-proof")
    public ResponseEntity<Resource> viewIdProof(Principal principal) throws IOException {

        String username = principal.getName();

        return passengerService.viewIdProof(username);
    }
}
